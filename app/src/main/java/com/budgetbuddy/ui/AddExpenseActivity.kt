...
class AddExpenseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("BudgetBuddy", "💸 Add Expense screen opened")
        ...
        btnCapturePhoto.setOnClickListener {
            Log.i("BudgetBuddy", "📸 Take Photo button clicked")
            dispatchTakePictureIntent()
        }
        btnPickFromGallery.setOnClickListener {
            Log.i("BudgetBuddy", "🖼️ Pick from Gallery button clicked")
            openGallery()
        }
        btnSave.setOnClickListener {
            Log.i("BudgetBuddy", "💾 Save Expense clicked")
            saveExpense()
        }
    }
    ...
    private fun loadCategories() {
        ...
        spinnerCategory.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: android.view.View?, pos: Int, id: Long) {
                ...
                Log.d("BudgetBuddy", "Category selected: ${categoryList[pos].second}")
            }
    ...
    private fun showDatePicker() {
        ...
        DatePickerDialog(this, { _: DatePicker, year: Int, month: Int, day: Int ->
            ...
            tvDate.text = selectedDate
            Log.d("BudgetBuddy", "Date picked: $selectedDate")
    ...
    private fun dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(packageManager) != null) {
            ...
            Log.d("BudgetBuddy", "Camera intent started")
        } else {
            Log.e("BudgetBuddy", "No camera app found")
    ...
    private fun openGallery() {
        ...
        Log.d("BudgetBuddy", "Gallery intent started")
    }
        ...
        when (requestCode) {
            REQUEST_IMAGE_CAPTURE -> {
                if (resultCode == RESULT_OK) {
                    ...
                    Log.d("BudgetBuddy", "Photo captured and preview shown")
                }
            }
            REQUEST_PICK_IMAGE -> {
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    if (selectedImageUri != null) {
                        ...
                        ivPreview.visibility = ImageView.VISIBLE
                        Log.d("BudgetBuddy", "Gallery image selected")
                    }
                }
            }
        }
    ...
    private fun saveExpense() {
        ...
        if (success) {
            Log.i("BudgetBuddy", "Expense saved: $title, R$amount")
            Toast.makeText(this, "Expense added", Toast.LENGTH_SHORT).show()
            finish()
        } else {
            Log.e("BudgetBuddy", "Failed to save expense")
