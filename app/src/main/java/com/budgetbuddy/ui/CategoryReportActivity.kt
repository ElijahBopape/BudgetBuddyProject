...
class CategoryReportActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("BudgetBuddy", "📊 Category report screen opened")
        ...
        btnFilter.setOnClickListener {
            Log.d("BudgetBuddy", "Filter report: $startDate to $endDate")
            loadReport()
        }
    ...
    private fun showDatePicker(isStart: Boolean) {
        ...
        DatePickerDialog(this, { _: DatePicker, year: Int, month: Int, day: Int ->
            ...
            Log.d("BudgetBuddy", "Report date: ${if (isStart) "start" else "end"} = $date")
    ...
    private fun loadReport() {
        ...
        cursor.close()
        Log.d("BudgetBuddy", "Loaded ${totals.size} category totals")
