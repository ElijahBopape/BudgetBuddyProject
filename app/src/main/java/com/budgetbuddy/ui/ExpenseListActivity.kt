...
class ExpenseListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("BudgetBuddy", "📋 Expense list screen opened")
        ...
        btnFilter.setOnClickListener {
            Log.d("BudgetBuddy", "Filter applied: $startDate to $endDate")
            loadExpenses()
        }
    ...
    private fun showDatePicker(isStart: Boolean) {
        ...
        DatePickerDialog(this, { _: DatePicker, year: Int, month: Int, day: Int ->
            ...
            Log.d("BudgetBuddy", "Date set: ${if (isStart) "start" else "end"} = $date")
    ...
    private fun loadExpenses() {
        ...
        cursor.close()
        Log.d("BudgetBuddy", "Loaded ${expenses.size} expenses")
